...
namespace ProjetoSEMESTRE.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ObservacoesId,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,PessoaId,UsuarioId")] Observacoes observacoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ObservacoesId,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,PessoaId,UsuarioId")] Observacoes observacoes)
        {
